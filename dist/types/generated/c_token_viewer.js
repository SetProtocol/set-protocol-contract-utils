...
var CTokenViewer_1 = require("../../artifacts/ts/CTokenViewer");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var CTokenViewerContract = /** @class */ (function (_super) {
    __extends(CTokenViewerContract, _super);
    function CTokenViewerContract(web3ContractInstance, defaults) {
    ...
    CTokenViewerContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    CTokenViewerContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = CTokenViewer_1.CTokenViewer.abi, networks = CTokenViewer_1.CTokenViewer.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new CTokenViewerContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    CTokenViewerContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = CTokenViewer_1.CTokenViewer.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('CTokenViewer', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return CTokenViewerContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.CTokenViewerContract = CTokenViewerContract;
//# sourceMappingURL=c_token_viewer.js.map