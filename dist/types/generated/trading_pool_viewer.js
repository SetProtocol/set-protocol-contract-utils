...
var TradingPoolViewer_1 = require("../../artifacts/ts/TradingPoolViewer");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var TradingPoolViewerContract = /** @class */ (function (_super) {
    __extends(TradingPoolViewerContract, _super);
    function TradingPoolViewerContract(web3ContractInstance, defaults) {
    ...
    TradingPoolViewerContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    TradingPoolViewerContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = TradingPoolViewer_1.TradingPoolViewer.abi, networks = TradingPoolViewer_1.TradingPoolViewer.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new TradingPoolViewerContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    TradingPoolViewerContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = TradingPoolViewer_1.TradingPoolViewer.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('TradingPoolViewer', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return TradingPoolViewerContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.TradingPoolViewerContract = TradingPoolViewerContract;
//# sourceMappingURL=trading_pool_viewer.js.map