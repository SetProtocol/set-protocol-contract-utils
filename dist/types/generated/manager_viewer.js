...
var ManagerViewer_1 = require("../../artifacts/ts/ManagerViewer");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var ManagerViewerContract = /** @class */ (function (_super) {
    __extends(ManagerViewerContract, _super);
    function ManagerViewerContract(web3ContractInstance, defaults) {
    ...
    ManagerViewerContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    ManagerViewerContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = ManagerViewer_1.ManagerViewer.abi, networks = ManagerViewer_1.ManagerViewer.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new ManagerViewerContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    ManagerViewerContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = ManagerViewer_1.ManagerViewer.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('ManagerViewer', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return ManagerViewerContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.ManagerViewerContract = ManagerViewerContract;
//# sourceMappingURL=manager_viewer.js.map