...
var ERC20Viewer_1 = require("../../artifacts/ts/ERC20Viewer");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var ERC20ViewerContract = /** @class */ (function (_super) {
    __extends(ERC20ViewerContract, _super);
    function ERC20ViewerContract(web3ContractInstance, defaults) {
    ...
    ERC20ViewerContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    ERC20ViewerContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = ERC20Viewer_1.ERC20Viewer.abi, networks = ERC20Viewer_1.ERC20Viewer.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new ERC20ViewerContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    ERC20ViewerContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = ERC20Viewer_1.ERC20Viewer.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('ERC20Viewer', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return ERC20ViewerContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.ERC20ViewerContract = ERC20ViewerContract;
//# sourceMappingURL=erc20_viewer.js.map