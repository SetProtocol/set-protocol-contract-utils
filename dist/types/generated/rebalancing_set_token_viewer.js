...
var RebalancingSetTokenViewer_1 = require("../../artifacts/ts/RebalancingSetTokenViewer");
var set_protocol_utils_1 = require("set-protocol-utils");
var base_contract_1 = require("../base_contract");
var common_1 = require("../common");
var RebalancingSetTokenViewerContract = /** @class */ (function (_super) {
    __extends(RebalancingSetTokenViewerContract, _super);
    function RebalancingSetTokenViewerContract(web3ContractInstance, defaults) {
    ...
    RebalancingSetTokenViewerContract.prototype.deploy = function (data, args) {
        return __awaiter(this, void 0, void 0, function () {
            var wrapper;
            return __generator(this, function (_a) {
                wrapper = this;
    ...
    RebalancingSetTokenViewerContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = RebalancingSetTokenViewer_1.RebalancingSetTokenViewer.abi, networks = RebalancingSetTokenViewer_1.RebalancingSetTokenViewer.networks;
                        web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);
                        return [2 /*return*/, new RebalancingSetTokenViewerContract(web3ContractInstance, defaults)];
                }
            });
        });
    };
    RebalancingSetTokenViewerContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = RebalancingSetTokenViewer_1.RebalancingSetTokenViewer.abi;
                        web3Utils = new set_protocol_utils_1.Web3Utils(web3);
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('RebalancingSetTokenViewer', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
    ...
    return RebalancingSetTokenViewerContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.RebalancingSetTokenViewerContract = RebalancingSetTokenViewerContract;
//# sourceMappingURL=rebalancing_set_token_viewer.js.map