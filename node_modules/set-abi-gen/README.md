...
This is a forked version of 0xProject abi-gen (https://github.com/0xProject/0x-monorepo/tree/development/packages/abi-gen).
...
See the [type definition](https://github.com/SetProtocol/set-abi-gen/src/types.ts) of what we pass to the render method.
