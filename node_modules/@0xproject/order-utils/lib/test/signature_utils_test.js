...
describe('Signature utils', function () {
    describe('#isValidSignatureAsync', function () {
        ...
        it('should return true for a valid Trezor signature', function () { return __awaiter(_this, void 0, void 0, function () {
            var trezorSignature, isValidSignatureLocal;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dataHex = '0xd0d994e31c88f33fd8a572552a70ed339de579e5ba49ee1d17cc978bbe1cdd21';
                        address = '0x6ecbe1db9ef729cbe972c83fb886247691fb6beb';
                        trezorSignature = '0x1ce4760660e6495b5ae6723087bea073b3a99ce98ea81fdf00c240279c010e63d05b87bc34c4d67d4776e8d5aeb023a67484f4eaf0fd353b40893e5101e845cd9908';
                        return [4 /*yield*/, signature_utils_1.signatureUtils.isValidSignatureAsync(web3_wrapper_1.provider, dataHex, trezorSignature, address)];
                    case 1:
                        isValidSignatureLocal = _a.sent();
                        expect(isValidSignatureLocal).to.be.true();
                        return [2 /*return*/];
    ...
    describe('#ecSignOrderHashAsync', function () {
        var stubs = [];
        var makerAddress;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, signature_utils_1.signatureUtils.ecSignOrderHashAsync(web3_wrapper_1.provider, orderHash, makerAddress, types_1.SignerType.Default)];
                    case 1:
                        ecSignature = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, signature_utils_1.signatureUtils.ecSignOrderHashAsync(fakeProvider, orderHash, makerAddress, types_1.SignerType.Default)];
                    case 1:
                        ecSignature = _a.sent();
                        expect(ecSignature).to.equal(expectedSignature);
                        return [2 /*return*/];
        ...
        it('should receive a payload modified with a prefix when Metamask is SignerType', function () { return __awaiter(_this, void 0, void 0, function () {
            var orderHash, orderHashPrefixed, expectedSignature, metamaskSignature, fakeProvider, ecSignature;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        orderHash = '0x34decbedc118904df65f379a175bb39ca18209d6ce41d5ed549d54e6e0a95004';
                        orderHashPrefixed = '0xae70f31d26096291aa681b26cb7574563956221d0b4213631e1ef9df675d4cba';
                        expectedSignature = '0x1b117902c86dfb95fe0d1badd983ee166ad259b27acb220174cbb4460d872871137feabdfe76e05924b484789f79af4ee7fa29ec006cedce1bbf369320d034e10b03';
                        metamaskSignature = '0x117902c86dfb95fe0d1badd983ee166ad259b27acb220174cbb4460d872871137feabdfe76e05924b484789f79af4ee7fa29ec006cedce1bbf369320d034e10b1b';
                        fakeProvider = {
                            sendAsync: function (payload, callback) {
                                return __awaiter(this, void 0, void 0, function () {
                                    var _a, message;
                                    return __generator(this, function (_b) {
                                        if (payload.method === 'eth_sign') {
                                            _a = __read(payload.params, 2), message = _a[1];
                        ...
                        return [4 /*yield*/, signature_utils_1.signatureUtils.ecSignOrderHashAsync(fakeProvider, orderHash, makerAddress, types_1.SignerType.Metamask)];
                    case 1:
                        ecSignature = _a.sent();
                        expect(ecSignature).to.equal(expectedSignature);
                        return [2 /*return*/];
    ...
    describe('#convertECSignatureToSignatureHex', function () {
        ...
        it('should concatenate v,r,s and append the Trezor signature type', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedSignatureWithSignatureType, signatureWithSignatureType;
            return __generator(this, function (_a) {
                expectedSignatureWithSignatureType = '0x1baca7da997ad177f040240cdccf6905b71ab16b74434388c3a72f34fd25d6439346b2bac274ff29b48b3ea6e2d04c1336eaceafda3c53ab483fc3ff12fac3ebf208';
                signatureWithSignatureType = signature_utils_1.signatureUtils.convertECSignatureToSignatureHex(ecSignature, types_1.SignerType.Trezor);
                expect(signatureWithSignatureType).to.equal(expectedSignatureWithSignatureType);
                return [2 /*return*/];
            });
        }); });
        it('should concatenate v,r,s and append the EthSign signature type when SignerType is Default', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedSignatureWithSignatureType, signatureWithSignatureType;
            return __generator(this, function (_a) {
                ...
                signatureWithSignatureType = signature_utils_1.signatureUtils.convertECSignatureToSignatureHex(ecSignature, types_1.SignerType.Default);
                expect(signatureWithSignatureType).to.equal(expectedSignatureWithSignatureType);
                return [2 /*return*/];
            });
        }); });
        it('should concatenate v,r,s and append the EthSign signature type when SignerType is Ledger', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedSignatureWithSignatureType, signatureWithSignatureType;
            return __generator(this, function (_a) {
                expectedSignatureWithSignatureType = '0x1baca7da997ad177f040240cdccf6905b71ab16b74434388c3a72f34fd25d6439346b2bac274ff29b48b3ea6e2d04c1336eaceafda3c53ab483fc3ff12fac3ebf203';
                signatureWithSignatureType = signature_utils_1.signatureUtils.convertECSignatureToSignatureHex(ecSignature, types_1.SignerType.Ledger);
                expect(signatureWithSignatureType).to.equal(expectedSignatureWithSignatureType);
                return [2 /*return*/];
            });
        }); });
        it('should concatenate v,r,s and append the EthSign signature type when SignerType is Metamask', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedSignatureWithSignatureType, signatureWithSignatureType;
            return __generator(this, function (_a) {
                expectedSignatureWithSignatureType = '0x1baca7da997ad177f040240cdccf6905b71ab16b74434388c3a72f34fd25d6439346b2bac274ff29b48b3ea6e2d04c1336eaceafda3c53ab483fc3ff12fac3ebf203';
                signatureWithSignatureType = signature_utils_1.signatureUtils.convertECSignatureToSignatureHex(ecSignature, types_1.SignerType.Metamask);
                expect(signatureWithSignatureType).to.equal(expectedSignatureWithSignatureType);
                return [2 /*return*/];
            });
        }); });
        it('should throw if the SignerType is invalid', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedMessage;
            return __generator(this, function (_a) {
                expectedMessage = 'Unrecognized SignerType: INVALID_SIGNER';
                expect(function () {
                    return signature_utils_1.signatureUtils.convertECSignatureToSignatureHex(ecSignature, 'INVALID_SIGNER');
