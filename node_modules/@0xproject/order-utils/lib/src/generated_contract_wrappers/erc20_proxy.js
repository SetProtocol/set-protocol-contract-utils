                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.addAuthorizedAddress(target);
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.removeAuthorizedAddress(target);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.removeAuthorizedAddressAtIndex(target, index);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
