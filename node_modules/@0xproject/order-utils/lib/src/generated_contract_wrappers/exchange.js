...
var ExchangeContract = /** @class */ (function (_super) {
    ...
    function ExchangeContract(abi, address, provider, txDefaults) {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.preSign(hash, signerAddress, signature);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.batchCancelOrders(orders);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.cancelOrdersUpTo(targetOrderEpoch);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.setSignatureValidatorApproval(validatorAddress, approval);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getOrdersInfo(orders);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.executeTransaction(salt, signerAddress, data, signature);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
        ...
        _this.registerAssetProxy = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                encodedData = self._lookupEthersInterface('registerAssetProxy(address)').functions.registerAssetProxy(assetProxy).data;
            ...
            getABIEncodedTransactionData: function (assetProxy) {
                ...
                var abiEncodedTransactionData = self._lookupEthersInterface('registerAssetProxy(address)').functions.registerAssetProxy(assetProxy).data;
                return abiEncodedTransactionData;
            },
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.registerAssetProxy(assetProxy);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.cancelOrder(order);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'abiEncodeFillOrder({address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes},uint256,bytes)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [order,
                                    takerAssetFillAmount,
                                    signature
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.abiEncodeFillOrder(order, takerAssetFillAmount, signature);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                            ...
                            case 2:
                                rawCallResult = _b.sent();
                                resultArray = ethersFunction.parse(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'abiEncodeFillOrder' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray[0]];
                        }
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.transferOwnership(newOwner);
                                encodedData = ethersFunction.data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
    ...
    ExchangeContract.deployFrom0xArtifactAsync = function (artifact, provider, txDefaults, _zrxAssetData) {
        return __awaiter(this, void 0, void 0, function () {
            var bytecode, abi;
            return __generator(this, function (_a) {
    ...
    ExchangeContract.deployAsync = function (bytecode, abi, provider, txDefaults, _zrxAssetData) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, constructorAbi, txData, web3Wrapper, txDataWithDefaults, txHash, txReceipt, contractInstance;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        txData = ethers.Contract.getDeployTransaction(bytecode, abi, _zrxAssetData);
