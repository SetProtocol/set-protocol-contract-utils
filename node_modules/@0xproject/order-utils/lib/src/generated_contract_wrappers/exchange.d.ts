...
import { CallData, ContractAbi, ContractArtifact, DecodedLogArgs, Provider, TxData } from 'ethereum-types';
...
export declare class ExchangeContract extends BaseContract {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact, provider: Provider, txDefaults: Partial<TxData>, _zrxAssetData: string): Promise<ExchangeContract>;
