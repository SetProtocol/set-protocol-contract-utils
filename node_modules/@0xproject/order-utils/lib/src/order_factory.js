...
exports.orderFactory = {
    ...
    createSignedOrderAsync: function (provider, makerAddress, makerAssetAmount, makerAssetData, takerAssetAmount, takerAssetData, exchangeAddress, createOrderOpts) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, signature_utils_1.signatureUtils.ecSignOrderHashAsync(provider, orderHash, makerAddress, types_1.SignerType.Default)];
                    case 1:
                        signature = _a.sent();
