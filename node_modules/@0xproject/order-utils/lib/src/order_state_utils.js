...
var OrderStateUtils = /** @class */ (function () {
    ...
    OrderStateUtils._validateIfOrderIsValid = function (signedOrder, sidedOrderRelevantState) {
        ...
        var isRoundingError = order_validation_utils_1.OrderValidationUtils.isRoundingError(remainingTakerAssetAmount, signedOrder.takerAssetAmount, signedOrder.makerAssetAmount);
        if (isRoundingError) {
     ...
     */
    OrderStateUtils.prototype.getOpenOrderStateAsync = function (signedOrder) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        remainingFillableTakerAssetAmountGivenMakersStatus = signedOrder.makerAssetAmount.eq(0)
                            ...
                            : utils_2.utils.getPartialAmount(orderRelevantMakerState.remainingFillableAssetAmount, signedOrder.makerAssetAmount, signedOrder.takerAssetAmount);
