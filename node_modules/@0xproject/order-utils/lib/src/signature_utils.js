...
exports.signatureUtils = {
    ...
    isValidSignatureAsync: function (provider, data, signature, signerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var signatureTypeIndexIfExists, _a, ecSignature, ecSignature, prefixedMessageHex, isValid, isValid, prefixedMessageHex, ecSignature;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case types_1.SignatureType.Caller: return [3 /*break*/, 4];
                            case types_1.SignatureType.Wallet: return [3 /*break*/, 5];
                            case types_1.SignatureType.Validator: return [3 /*break*/, 7];
                            case types_1.SignatureType.PreSigned: return [3 /*break*/, 9];
                            case types_1.SignatureType.Trezor: return [3 /*break*/, 10];
                        }
                        return [3 /*break*/, 11];
                    ...
                    case 5: return [4 /*yield*/, exports.signatureUtils.isValidWalletSignatureAsync(provider, data, signature, signerAddress)];
                    case 6:
                        isValid = _b.sent();
                        return [2 /*return*/, isValid];
                    case 7: return [4 /*yield*/, exports.signatureUtils.isValidValidatorSignatureAsync(provider, data, signature, signerAddress)];
                    case 8:
                        isValid = _b.sent();
                        return [2 /*return*/, isValid];
                    case 9:
                    ...
                    case 10:
                        {
                            prefixedMessageHex = exports.signatureUtils.addSignedMessagePrefix(data, types_1.SignerType.Trezor);
                            ecSignature = exports.signatureUtils.parseECSignature(signature);
                            return [2 /*return*/, exports.signatureUtils.isValidECSignature(prefixedMessageHex, ecSignature, signerAddress)];
                        }
                        _b.label = 11;
                    case 11: throw new Error("Unhandled SignatureType: " + signatureTypeIndexIfExists);
                }
            });
        });
    },
    ...
    convertECSignatureToSignatureHex: function (ecSignature, signerType) {
        ...
        switch (signerType) {
            ...
            case types_1.SignerType.Trezor: {
                signatureType = types_1.SignatureType.Trezor;
                break;
            }
            default:
    ...
    addSignedMessagePrefix: function (message, signerType) {
        ...
        switch (signerType) {
            ...
            case types_1.SignerType.Trezor: {
                var msgBuff = ethUtil.toBuffer(message);
                var prefixedMsgBuff = hashTrezorPersonalMessage(msgBuff);
                var prefixedMsgHex = ethUtil.bufferToHex(prefixedMsgBuff);
                return prefixedMsgHex;
            }
            default:
    ...
    parseECSignature: function (signature) {
        assert_1.assert.isHexString('signature', signature);
        var ecSignatureTypes = [types_1.SignatureType.EthSign, types_1.SignatureType.EIP712, types_1.SignatureType.Trezor];
...
function hashTrezorPersonalMessage(message) {
