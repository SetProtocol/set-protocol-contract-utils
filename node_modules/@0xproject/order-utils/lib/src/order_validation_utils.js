...
var OrderValidationUtils = /** @class */ (function () {
     ...
     */
    OrderValidationUtils.isRoundingError = function (numerator, denominator, target) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        fillMakerTokenAmount = utils_1.utils.getPartialAmount(fillTakerAssetAmount, signedOrder.takerAssetAmount, signedOrder.makerAssetAmount);
                    ...
                    case 2:
                        _a.sent();
                        makerFeeAmount = utils_1.utils.getPartialAmount(fillTakerAssetAmount, signedOrder.takerAssetAmount, signedOrder.makerFee);
                    ...
                    case 3:
                        _a.sent();
                        takerFeeAmount = utils_1.utils.getPartialAmount(fillTakerAssetAmount, signedOrder.takerAssetAmount, signedOrder.takerFee);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        wouldRoundingErrorOccur = OrderValidationUtils.isRoundingError(desiredFillTakerTokenAmount, signedOrder.takerAssetAmount, signedOrder.makerAssetAmount);
