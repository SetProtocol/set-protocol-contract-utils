...
exports.marketUtils = {
    ...
    findOrdersThatCoverMakerAssetFillAmount: function (orders, makerAssetFillAmount, opts) {
        ...
        var result = _.reduce(orders, function (_a, order, index) {
            var resultOrders = _a.resultOrders, remainingFillAmount = _a.remainingFillAmount;
            if (remainingFillAmount.lessThanOrEqualTo(constants_1.constants.ZERO_AMOUNT)) {
                return { resultOrders: resultOrders, remainingFillAmount: constants_1.constants.ZERO_AMOUNT };
            }
            else {
                ...
                return {
                    resultOrders: makerAssetAmountAvailable.gt(constants_1.constants.ZERO_AMOUNT)
        ...
        }, { resultOrders: [], remainingFillAmount: totalFillAmount });
        return result;
    },
    /**
