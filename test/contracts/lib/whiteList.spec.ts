...
import { WhiteListHelper } from '@utils/helpers/whiteListHelper';
...
contract('WhiteList', accounts => {
  ...
  const whiteListHelper = new WhiteListHelper(ownerAccount);
  ...
  describe('#constructor', async () => {
    ...
    async function subject(): Promise<WhiteListContract> {
      return await whiteListHelper.deployWhiteListAsync(
        subjectInitialAddresses,
        subjectCaller
      );
    }
  ...
  describe('#addAddress', async () => {
    ...
    beforeEach(async () => {
      whiteList = await whiteListHelper.deployWhiteListAsync([firstTokenAddress, secondTokenAddress]);
  ...
  describe('#removeAddress', async () => {
    ...
    beforeEach(async () => {
      whiteList = await whiteListHelper.deployWhiteListAsync(
