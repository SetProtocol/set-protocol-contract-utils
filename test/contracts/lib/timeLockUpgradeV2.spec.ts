...
import { UpgradeRegisteredV2, RemoveRegisteredUpgrade } from '@utils/contract_logs/timelockUpgrade';
...
contract('TimeLockUpgradeV2', accounts => {
  ...
  beforeEach(async () => {
    ...
    timeLockUpgradeMock = await permissionHelper.deployTimeLockUpgradeV2MockAsync();
  });
