...
import { UpgradeRegistered, RemoveRegisteredUpgrade } from '@utils/contract_logs/timelockUpgrade';
...
contract('UnrestrictedTimeLockUpgrade', accounts => {
  ...
  beforeEach(async () => {
    ...
    timeLockUpgradeMock = await permissionHelper.deployUnrestrictedTimeLockUpgradeMockAsync();
  });
