...
import { Migrations as ContractArtifacts } from '../../artifacts/ts/Migrations';
...
export class MigrationsContract extends BaseContract {
  ...
  static async deployed(web3: Web3, defaults: Tx): Promise<MigrationsContract> {
  ...
  static async at(
    ...
    if (contractExists) {
      ...
      throw new Error(
        CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('Migrations', currentNetwork),
      );
    }
  }
