...
import { AddressToAddressWhiteList as ContractArtifacts } from '../../artifacts/ts/AddressToAddressWhiteList';
...
export class AddressToAddressWhiteListContract extends BaseContract {
  public keys = {
    async callAsync(
      index_0: BigNumber,
      defaultBlock?: any,
  ...
  > {
      const self = this as AddressToAddressWhiteListContract;
      const result = await promisify<string
  >(
        self.web3ContractInstance.methods.keys(
  ...
  public addPair = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
        txData,
        self.addPair.estimateGasAsync.bind(
          self,
          this.formatABIDataItem(
          	'address',
          	[
      ...
      const txHash = await promisify<string>(
        self.web3ContractInstance.methods.addPair(
          this.formatABIDataItem(
          	'address',
          	[
          	],_key),
    ...
    getABIEncodedTransactionData(
      ...
      const self = this as AddressToAddressWhiteListContract;
      const abiEncodedTransactionData = self.web3ContractInstance.methods.addPair(
        this.formatABIDataItem(
        	'address',
        	[
        	],_key),
  ...
  public removePair = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
        txData,
        self.removePair.estimateGasAsync.bind(
          self,
          this.formatABIDataItem(
          	'address',
          	[
      ...
      const txHash = await promisify<string>(
        self.web3ContractInstance.methods.removePair(
          this.formatABIDataItem(
          	'address',
          	[
          	],_key),
    ...
    getABIEncodedTransactionData(
      ...
      const self = this as AddressToAddressWhiteListContract;
      const abiEncodedTransactionData = self.web3ContractInstance.methods.removePair(
        this.formatABIDataItem(
        	'address',
        	[
        	],_key),
  ...
  public editPair = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
        txData,
        self.editPair.estimateGasAsync.bind(
          self,
          this.formatABIDataItem(
          	'address',
          	[
      ...
      const txHash = await promisify<string>(
        self.web3ContractInstance.methods.editPair(
          this.formatABIDataItem(
          	'address',
          	[
          	],_key),
    ...
    getABIEncodedTransactionData(
      ...
      const self = this as AddressToAddressWhiteListContract;
      const abiEncodedTransactionData = self.web3ContractInstance.methods.editPair(
        this.formatABIDataItem(
        	'address',
        	[
        	],_key),
  ...
  > {
      ...
      const result = await promisify<string[]
  >(
        self.web3ContractInstance.methods.getValues(
          this.formatABIDataItem(
          	'address[]',
          	[
          	],_key),
  ...
  > {
      ...
      const result = await promisify<string
  >(
        self.web3ContractInstance.methods.getValue(
          this.formatABIDataItem(
          	'address',
          	[
          	],_key),
  ...
  static async deployed(web3: Web3, defaults: Tx): Promise<AddressToAddressWhiteListContract> {
    const web3Utils = new Web3Utils(web3);
    const currentNetwork = await web3Utils.getNetworkIdAsync();
    const { abi, networks }: { abi: any[]; networks: any } = ContractArtifacts;
    const web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);

    return new AddressToAddressWhiteListContract(web3ContractInstance, defaults);
  }
  static async at(
    address: string,
    web3: Web3,
    ...
    if (contractExists) {
      ...
      throw new Error(
        CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('AddressToAddressWhiteList', currentNetwork),
      );
    }
  }
