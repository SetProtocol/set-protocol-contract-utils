...
import { TimeLockUpgradeV2Mock as ContractArtifacts } from '../../artifacts/ts/TimeLockUpgradeV2Mock';
...
export class TimeLockUpgradeV2MockContract extends BaseContract {
  ...
  > {
      const self = this as TimeLockUpgradeV2MockContract;
  ...
  static async deployed(web3: Web3, defaults: Tx): Promise<TimeLockUpgradeV2MockContract> {
    const web3Utils = new Web3Utils(web3);
    const currentNetwork = await web3Utils.getNetworkIdAsync();
    const { abi, networks }: { abi: any[]; networks: any } = ContractArtifacts;
    const web3ContractInstance = new web3.eth.Contract(abi, networks[currentNetwork].address);

    return new TimeLockUpgradeV2MockContract(web3ContractInstance, defaults);
  }
  static async at(
    address: string,
    web3: Web3,
    ...
    if (contractExists) {
      ...
      throw new Error(
        CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('TimeLockUpgradeV2Mock', currentNetwork),
      );
    }
  }
