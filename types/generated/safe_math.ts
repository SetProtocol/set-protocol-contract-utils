...
import { SafeMath as ContractArtifacts } from '../../artifacts/ts/SafeMath';
...
export class SafeMathContract extends BaseContract {
  ...
  static async deployed(web3: Web3, defaults: Tx): Promise<SafeMathContract> {
  ...
  static async at(
    ...
    if (contractExists) {
      ...
      throw new Error(
        CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('SafeMath', currentNetwork),
      );
    }
  }
