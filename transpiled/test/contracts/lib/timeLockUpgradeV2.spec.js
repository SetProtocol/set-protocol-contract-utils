...
var TimeLockUpgradeV2 = artifacts.require('TimeLockUpgradeV2');
...
contract('TimeLockUpgradeV2', function (accounts) {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, permissionHelper.deployTimeLockUpgradeV2MockAsync()];
                case 2:
        ...
        return __generator(this, function (_a) {
            ...
            describe('when the timeLockPeriod is positive && no hash is set', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    it('emits a UpgradeRegisteredV2 event', function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 4:
                                    ...
                                    upgradeHash = web3.utils.soliditySha3(input);
                                    expectedLogs = [
                                        timelockUpgrade_1.UpgradeRegisteredV2(timeLockUpgradeMock.address, upgradeHash, timestamp.toString(), input),
                                    ];
                    ...
                    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    subjectCaller = ownerAccount;
                                    return [4 /*yield*/, timeLockUpgradeMock.setTimeLockPeriod.sendTransactionAsync(subjectTimeLockPeriod, { from: subjectCaller })];
                                case 1:
                                    _a.sent();
    ...
    describe('#removeRegisteredUpgrade', function () { return __awaiter(_this, void 0, void 0, function () {
        function subject() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, timeLockUpgradeMock.removeRegisteredUpgrade.sendTransactionAsync(subjectHash, { from: subjectCaller })];
                });
            });
        }
        var subjectHash, subjectCaller, subjectTestUint;
        var _this = this;
        return __generator(this, function (_a) {
            ...
            beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            subjectCaller = ownerAccount;
                            return [4 /*yield*/, timeLockUpgradeMock.setTimeLockPeriod.sendTransactionAsync(constants_1.ONE, { from: subjectCaller })];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, timeLockUpgradeMock.testTimeLockUpgrade.sendTransactionAsync(subjectTestUint, { from: subjectCaller })];
                        case 2:
            ...
            it('sets the upgradeHash to 0', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, timeLockUpgradeMock.timeLockedUpgrades.callAsync(subjectHash)];
                        case 2:
                            actualTimestamp = _a.sent();
                            expect(actualTimestamp).to.bignumber.equal(constants_1.ZERO);
                            return [2 /*return*/];
            ...
            it('emits a RemoveRegisteredUpgrade event', function () { return __awaiter(_this, void 0, void 0, function () {
                var txHash, logs, expectedLogs;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, subject()];
                        case 1:
                        ...
                        case 2:
                            logs = _a.sent();
                            expectedLogs = [
                                timelockUpgrade_1.RemoveRegisteredUpgrade(timeLockUpgradeMock.address, subjectHash),
                            ];
                            return [4 /*yield*/, SetTestUtils.assertLogEquivalence(logs, expectedLogs)];
                        case 3:
                            _a.sent();
...
//# sourceMappingURL=timeLockUpgradeV2.spec.js.map